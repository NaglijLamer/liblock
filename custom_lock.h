...
int temp_var_custom_lock_fot_mutex_attr = 1;
#define custom_lock_lock pthread_mutex_lock_c
#define custom_lock_unlock pthread_mutex_unlock_c
#define custom_lock_init(lock, attr) pthread_mutex_init_c(lock, attr == 1 ? (void*)(&temp_var_custom_lock_fot_mutex_attr) : NULL)
